...
<div class="wrap w960">
	<div class="maxBox">
        ...
        {/playpage:playlist}
		<script>PlayHistoryObj.addPlayHistory('{playpage:name}{playpage:part}',location.href)</script>
		<script type="text/javascript" src="/include/ajax.php?action=hit&id={playpage:id}"></script>
	</div>
